      ...
      return this.length > 1
        ...
        : ((this.initialize = function () {
          ...
          (this.showSpinner = function () {
            return (
              e(this).addClass("show-spinner"), e(this).addClass("active"), this
            );
          }),
          ...
          (this.showFail = function (t) {
            return (
              e(this).addClass("show-fail"),
              e(this).removeClass("show-spinner"),
              t && e(this).find(".icon.fail").tooltip("show"),
              this
            );
          }),
          (this.showSuccess = function (t) {
            return (
              e(this).addClass("show-success"),
              e(this).removeClass("show-spinner"),
              t && e(this).find(".icon.success").tooltip("show"),
              this
            );
          }),
          (this.reset = function () {
            this.hideTooltips(),
              this.hideSpinner(),
              e(this).removeClass("show-success"),
              e(this).removeClass("show-fail"),
  ...
  ($.shiftSelectable = function (e, t) {
    ...
    function s(e, t) {
      ...
      if (i) {
        ...
        r.each(function () {
          ...
          s
            ? i.prop("indeterminate", s)
            : (i.prop("indeterminate", s), i.prop("checked", s)),
    ...
    o.data("checkAll") &&
      (i = $("#" + o.data("checkAll"))).on("click", function () {
        r.prop("checked", $(i).prop("checked")).trigger("change"),
      ...
      o.on("click", t.items, function (e) {
        $(e.target).is("a") ||
          ...
          s($(this).find("input[type='checkbox']")[0], e.shiftKey));
      }),
      (a.update = function () {
        r = o.find("input[type='checkbox']");
      }),
  ...
  ($.dore = function (e, t) {
    ...
    !(function () {
      ...
      var e = getComputedStyle(document.body),
        ...
        c =
          (e.getPropertyValue("--theme-color-6").trim(),
          e.getPropertyValue("--theme-color-1-10").trim()),
        ...
        g =
          (e.getPropertyValue("--theme-color-6-10").trim(),
      ...
      function C() {
        ...
        $(".navbar").outerHeight(),
          parseInt($(".sub-menu .scroll").css("margin-top"), 10);
        $(".chat-app .scroll").length > 0 &&
          me &&
      ...
      function y() {
        $(".search").hasClass("mobile-view") &&
          ($(".search").removeClass("mobile-view"), $(".search input").val(""));
      }
      ...
      function x(e, t, a) {
        ...
        if (0 != n.length) {
          a = a || S();
          if (
            0 == $(".sub-menu ul[data-link='" + a + "']").length &&
            (2 == v || t) &&
            $(window).outerWidth() >= 768 &&
            B("menu-default")
          )
          ...
          e % 4 == 0
            ...
            : e % 4 == 3 &&
              (B("menu-main-hidden")
                ...
                : B("menu-default") && B("menu-sub-hidden")
                ? (nextClasses =
                    "menu-default menu-sub-hidden sub-show-temporary")
                : B("menu-default")
                ? (nextClasses = "menu-default sub-hidden")
                : B("menu-sub-hidden")
      ...
      $(".menu-button").on("click", function (e) {
        ...
        $(document).on("click", function (e) {
          if (
            !(
              $(e.target).parents().hasClass("menu-button") ||
              $(e.target).hasClass("menu-button") ||
              $(e.target).parents().hasClass("sidebar") ||
              $(e.target).hasClass("sidebar")
            )
          ) {
            if (
              $(e.target).parents("a[data-toggle='collapse']").length > 0 ||
              "collapse" == $(e.target).attr("data-toggle")
            )
              return;
            if ($("#app-container").hasClass("menu-sub-hidden") && 3 == v)
              x(S() == W ? 2 : 0);
            else
      ...
      function T(e) {
        if (0 != $(".main-menu").length) {
          ...
          t != W &&
            ...
            $(".sub-menu ul[data-link='" + t + "']").slideDown(100),
      ...
      if (
        ...
        (Chart.defaults.global.defaultFontFamily = "'Nunito', sans-serif"),
            ...
            Chart.controllers.doughnut.extend({
              draw: function (e) {
                ...
                t.save(),
                  ...
                  (t.shadowOffsetY = 10),
                  (t.responsive = !0),
                  Chart.controllers.doughnut.prototype.draw.apply(
                    this,
                    arguments
                  ),
                  t.restore();
          ...
          (Chart.controllers.ScatterWithShadow =
            Chart.controllers.scatter.extend({
              draw: function (e) {
                ...
                t.save(),
                  ...
                  (t.shadowOffsetY = 7),
                  (t.responsive = !0),
                  Chart.controllers.scatter.prototype.draw.apply(
                    this,
                    arguments
                  ),
                  t.restore();
          ...
          (Chart.controllers.PolarWithShadow =
            Chart.controllers.polarArea.extend({
              draw: function (e) {
                ...
                t.save(),
                  ...
                  (t.shadowOffsetY = 10),
                  (t.responsive = !0),
                  Chart.controllers.polarArea.prototype.draw.apply(
                    this,
                    arguments
                  ),
                  t.restore();
        ...
        var R = {
            ...
            tooltips: {
              ...
              custom: function (e) {
                if (e && e.dataPoints) {
                  ...
                  t.find(".value").html("$" + $.fn.addCommas(a)),
                    t.find(".label").html(o + "-" + n);
                }
              },
            },
            scales: {
          ...
          L = {
            afterInit: function (e, t) {
              ...
              a.find(".value").html("$" + $.fn.addCommas(n)),
                a.find(".label").html(i + "-" + o);
            },
          };
        ...
        var ee = {
          ...
          beforeDraw: function (e) {
            ...
            (d = e.legend.legendItems[0].hidden ? 0 : d),
              e.pointAvailable &&
                ...
                (l = (s = (r = e.data.datasets[e.pointDataIndex])._meta[
                  Object.keys(r._meta)[0]
                ]).total),
                (d = parseFloat(((i / l) * 100).toFixed(1))),
            ...
            var c = d + "%",
              ...
              u = a / 2;
            n.fillText(c, p, u),
              (n.font = "14px Nunito, sans-serif"),
              (n.textBaseline = "middle");
            var h = o;
            (p = Math.round((t - n.measureText(h).width) / 2)),
              (u = a / 2 - 30);
          ...
          beforeEvent: function (e, t, a) {
            ...
            n &&
              ((e.pointIndex = n._index),
              (e.pointDataIndex = n._datasetIndex),
              (e.pointAvailable = !0));
          },
        };
      ...
      if ($().DataTable) {
        ...
        var main_url = $("#base-url").attr("href");
        var ket_data = $(".page-title").text();
        var countTh = $("#datatableRows th").length;
        var hasWhiteSpace = new RegExp("\\s+");

        if (hasWhiteSpace.test(ket_data)) {
          controller = ket_data.replace(/ /g, "_");
        } else {
          controller = ket_data;
        }

        ce = $("#datatableRows").DataTable({
          ajax: {
            url: main_url + "controllers/" + controller.toLowerCase() + ".php",
            method: "post",
            data: function (e) {
              e.action = "select";
            },
          ...
          order: [[0, "false"]],
          language: {
            emptyTable: "Belum ada data pada tabel ini.",
          ...
          drawCallback: function () {
            ...
            $("#pageCountDatatable span").html(
              "Displaying " +
                parseInt(e.page.info().start + 1) +
                "-" +
                e.page.info().end +
                " of " +
                e.page.info().recordsTotal +
                " items"
            );
        ...
        ce.on("order.dt search.dt", function () {
          ce.column(0, { search: "applied", order: "applied" })
            .nodes()
            .each(function (cell, i) {
              cell.innerHTML = i + 1;
              ce.cell(cell).invalidate("dom");
            });
        }).draw();
          ...
          $("#datatableRows tbody").on("click", "tr", function () {
            ...
            e.prop("checked", !e.prop("checked")).trigger("change"),
              (function () {
                var e = !1,
                  t = !0;
                $("#datatableRows tbody tr .custom-checkbox input").each(
                  function () {
                    $(this).prop("checked") ? (e = !0) : (t = !1);
                  }
                ),
                  e
                    ? $("#checkAllDataTables").prop("indeterminate", e)
                    : ($("#checkAllDataTables").prop("indeterminate", e),
                      $("#checkAllDataTables").prop("checked", e));
                t &&
                  ($("#checkAllDataTables").prop("indeterminate", !1),
                  $("#checkAllDataTables").prop("checked", t));
              })();
          }),
        ...
        var be = document.querySelectorAll(".cropper-preview"),
          Ce = {
            ...
            ready: function () {
              ...
              (e.className = ""),
                (e.style.cssText =
                  "display: block;width: 100%;min-width: 0;min-height: 0;max-width: none;max-height: none;"),
                fe(be, function (t) {
            ...
            crop: function (e) {
              ...
              fe(be, function (e) {
                ...
                (e.style.height = r + "px"),
                  o &&
                    ((o.style.width = a.naturalWidth / s + "px"),
                    (o.style.height = a.naturalHeight / s + "px"),
                    (o.style.marginLeft = -t.x / s + "px"),
                    (o.style.marginTop = -t.y / s + "px"));
              });
            },
            zoom: function (e) {},
          };
        if ($("#inputImage").length > 0) {
          ...
          ye.onchange = function () {
            ...
            t &&
              ...
              /^image\/\w+/.test(e.type)
                ? ((uploadedImageType = e.type),
                  (uploadedImageName = e.name),
                  (ve.src = uploadedImageURL = URL.createObjectURL(e)),
                  we && we.destroy(),
                  (we = new ge(ve, Ce)),
                  (ye.value = null))
      ...
      "undefined" != typeof noUiSlider &&
        ...
        $("#exampleModalContent").on("show.bs.modal", function (e) {
          var t = $(e.relatedTarget).data("whatever"),
            a = $(this);
          a.find(".modal-title").text("New message to " + t),
            a.find(".modal-body input").val(t);
        }),
          ...
          $(".scroll").each(function () {
            if ($(this).parents(".chat-app").length > 0) {
              ...
              function a() {
                var a = 0;
                $("main").length > 0 &&
                  (a += parseInt($("main").css("margin-top"))),
                  $(".chat-input-container").length > 0 &&
                    (a += $(".chat-input-container").outerHeight(!0)),
                  $(".chat-heading-container").length > 0 &&
                    (a += $(".chat-heading-container").outerHeight(!0)),
                  $(".separator").length > 0 &&
                    (a += $(".separator").outerHeight(!0)),
                  $(".chat-app .scroll").css(
                    "height",
                  ...
                  window.innerWidth < 576
                    ? (me && (me.destroy(), (me = null)),
                      $(".chat-app .scroll-content > div:last-of-type").css(
                        "padding-bottom",
                        $(".chat-input-container").outerHeight(!0) + "px"
                      ),
                      t ||
                        (setTimeout(function () {
                          $("html, body").animate(
        ...
        "undefined" != typeof Sortable &&
          ($(".sortable").each(function () {
            $(this).find(".handle").length > 0
              ? Sortable.create($(this)[0], {
                  handle: ".handle",
                })
              : Sortable.create($(this)[0]);
          }),
          $(".sortable-survey").length > 0 &&
      ...
      if (
        ("undefined" != typeof ClassicEditor &&
        ...
        "undefined" != typeof Mousetrap &&
          (Mousetrap.bind(["ctrl+down", "command+down"], function (e) {
            ...
            return (
              0 == t.length &&
                (t = $(".sub-menu li.active").parent().children().first()),
          ...
          Mousetrap.bind(["ctrl+up", "command+up"], function (e) {
            ...
            return (
              0 == t.length &&
                (t = $(".sub-menu li.active").parent().children().last()),
              (window.location.href = t.find("a").attr("href")),
              !1
            );
          }),
          ...
          $.contextMenu({
            ...
            events: {
              show: function (e) {
                ...
                t &&
                  t.length > 0 &&
                  t.data("shiftSelectable").rightClick(e.$trigger);
              },
            },
            items: {
              copy: {
        ...
        $("#smartWizardDefault").smartWizard({
          ...
          $("#smartWizardValidation .finish-btn").on("click", function (e) {
            return (
              !Be($("#smartWizardValidation #form-step-1")) ||
              (console.log("Form Done"), !1)
            );
          });
      }
      ...
      if (
        ("undefined" != typeof baguetteBox &&
          (baguetteBox.run(".gallery"), baguetteBox.run(".lightbox")),
        $().ellipsis &&
          $(".ellipsis").ellipsis({
            live: !0,
          }),
        ...
        if ($(".glide.details").length > 0) {
          ...
          function De(e) {
            $(".glide.thumbs li").removeClass("active"),
              $($(".glide.thumbs li")[e]).addClass("active"),
              e >= ze.index + Ae && ze.go(">"),
              e < ze.index && ze.go("<");
          }
        ...
        $().validate &&
          ($.validator.setDefaults({
            ...
            errorPlacement: function (e, t) {
              -1 != t.attr("class").indexOf("custom-control")
